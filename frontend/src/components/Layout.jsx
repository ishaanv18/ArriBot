...
import { Home, LayoutDashboard, MessageSquare, BookOpen, BrainCircuit, FileText, Mail, LogIn, User, Briefcase, MapPin } from 'lucide-react';
...
const Layout = ({ children }) => {
    ...
    const navItems = [
        ...
        ...(isAuthenticated ? [
            ...
            { path: '/learning-path', label: 'Learn Path', icon: MapPin },
        ] : [
