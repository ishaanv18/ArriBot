...
const FeatureCard = ({ title, desc, icon: Icon, delay, isNew = false }) => (
    <motion.div
        className="bg-glass-base backdrop-blur-md border border-white/5 rounded-2xl p-8 flex flex-col justify-between group hover:bg-white/10 hover:border-cyan-glow/30 transition-all duration-500 h-full min-h-[250px] relative overflow-hidden"
    ...
    >
        {isNew && (
            <div className="absolute top-4 right-4 flex items-center gap-1.5">
                ...
                <span className="text-[10px] font-bold font-mono tracking-widest text-cyan-400 uppercase">NEW</span>
            </div>
        )}
        <div>
            ...
            <Section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <FeatureCard
                        ...
                        desc="Upload your resume for AI-driven skill gap analysis and career readiness scoring."
                        icon={Briefcase}
                        delay={0.5}
                    />
                    <FeatureCard
                        title="Learning Path"
                        desc="Input any goal — AI builds a personalized multi-week curriculum with daily flashcard, quiz & summary milestones."
                        icon={MapPin}
                        delay={0.6}
                        isNew
                    />
