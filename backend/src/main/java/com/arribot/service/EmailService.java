...
public class EmailService {
    ...
    private void sendEmail(String toEmail, String toName, String subject, String htmlContent) throws IOException {
        ...
        try (Response response = httpClient.newCall(request).execute()) {
            ...
            if (!response.isSuccessful()) {
                throw new IOException("Brevo API error: " + response.code() + " - " + responseBody);
            }
        }
    }
    ...
    public void sendOTP(String toEmail, String otp) throws IOException {
        ...
        try {
            sendEmail(toEmail, null, subject, htmlContent);
        } catch (IOException ex) {
            System.err.println("Failed to send OTP email via Brevo: " + ex.getMessage());
            throw ex;
        }
    }
    ...
    public void sendWelcomeEmail(String toEmail, String fullName) throws IOException {
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="feature-box">
                            <p class="feature-title">🗺️ Learning Path Generator</p>
                            <span style="color: #94a3b8; font-size: 14px;">AI-powered multi-week curricula tailored to your goals.</span>
                        </div>
        ...
        try {
            sendEmail(toEmail, fullName, subject, htmlContent);
        } catch (IOException ex) {
            System.err.println("Failed to send welcome email via Brevo: " + ex.getMessage());
            throw ex;
        }
    }
    ...
    public void sendContactFormEmail(String name, String email, String message) throws IOException {
        ...
        try {
            sendEmail(fromEmail, "ArriBot Admin", subject, htmlContent);
        } catch (IOException ex) {
            System.err.println("Failed to send contact form email via Brevo: " + ex.getMessage());
            throw ex;
        }
    }
}
